    ...
    internal class GetQaAdvisorsTests
    {
        ...
        public void Setup()
        {
            ...
            _qaAdvisorList = new List<QaAdvisor>()
            {
                ...
                new QaAdvisor() { Id = Guid.Parse("3A204FB3-1956-4EFC-BE34-89F7897570DB"), Forename = "H&S", Surname = "Reports", Email = "H&S.Reports@Peninsula-uk.com", InRotation = true},
        ...
        public void Given_QA_Advisors_Ensure_HealthAndSafety_In_List_With_Correct_Values_Assigned()
        {
            ...
            Assert.That(result[2].InRotation, Is.True);
        }
