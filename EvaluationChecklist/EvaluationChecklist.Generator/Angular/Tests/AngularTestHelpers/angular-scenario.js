  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse',
    ...
    Scope.prototype = {
      ...
      $destroy: function() {
        ...
        // see: https://github.com/angular/angular.min.js/issues/1313#issuecomment-10378451
...
function $SnifferProvider() {
  this.$get = ['$window', function($window) {
    ...
    return {
      ...
      // https://github.com/angular/angular.min.js/issues/904
 ...
 *
 * `ngCloak` works in cooperation with a css rule that is embedded within `angular.min.js` and
 ...
 *
 * For the best result, `angular.min.js` script must be loaded in the head section of the html file;
 ...
 * These rules are bundled with angular.min.js and the rules can be overridden
