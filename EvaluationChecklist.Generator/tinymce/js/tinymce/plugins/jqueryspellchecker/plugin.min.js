...
(function () {
    ...
    tinymce.create('tinymce.plugins.jQuerySpellcheckerPlugin', {
        ...
        init: function (ed, url) {
            ...
            ed.addButton('jqueryspellchecker', {
                title: 'spellchecker.desc',
                cmd: 'mcejQuerySpellCheck',
                class: 'jqueryspellchecker'
            });
        ...
        _onCheck: function () {
            ...
            if (!t.spellchecker) {
                try {
                    ...
                    alert("An error has occured during spellchecking");
                    console.log(ex);
        ...
        createControl: function (n, cm) {
            console.log('creating jquery spellcheck button1');
            if (n == 'jqueryspellchecker') {
                console.log('creating jquery spellcheck button2');
